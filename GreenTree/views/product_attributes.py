...
def get_product_attributes():
    cursor.execute("SELECT * FROM product_attributes")    # execute a query
...
def product_attributes():
    ...
    return render_template('product_attributes/product_attributes.html', product_attributes=product_attributes)
...
def add_product_attribute_page():
    ...
    # if the request is a get
        ...
        return render_template('product_attributes/add_product_attribute.html')
...
def edit_product_attribute_page(product_attribute_id):
    ...
    # if the request is a get
        ...
        return render_template('product_attributes/edit_product_attribute.html', product_attribute=results)
